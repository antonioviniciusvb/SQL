...
-- Visualiza todos os dados da tabela tb_produtos onde corresponder com lista
SELECT * FROM tb_produtos
WHERE preco in (5,10,15);

-- Intervalo de datas
SELECT * FROM tb_produtos
WHERE dtvalidade between "2022-03-05" AND "2022-03-10"
order by dtvalidade;

select * from tb_produtos
where nome like "sacola%";

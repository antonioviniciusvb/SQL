...
-- 2 INNER JOIN com 3 tabelas
select tb_usuarios.nome, tb_produtos.nome, tb_produtos.console, tb_produtos.preco, tb_categorias.tipo
from tb_produtos 
